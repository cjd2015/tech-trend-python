# TechTrend Intelligence Briefing Protocol
...
Run the full TechTrend sweep:

```bash
cd C:/Users/ishan/Documents/TechTrend && node apis/briefing.mjs 2>&1
```
